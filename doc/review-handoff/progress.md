...
**次にやること**: Wave 3 の5体（写真の撮影基盤・紙面検査の新設・図30枚・画像重複検査＋リリース後リスト・再構成ビルド `--all`）の結果をワイが裏取りし、写真70枚を撮り切る。
...
| ④ | 誤字・矛盾を1個見つける | ✅ **70件修正** |
| ⑤ | 紙面が崩れとる | 🔄 `check_page_layout.py` 新設中。組版の疎通は確認ずみ |
| ⑥ | スクショと自分の画面が違う | 🔄 撮影基盤を構築中 |
| ⑦ | 説明が無い | 🔶 用語節10本 ✅／図30枚は作図中 |
| ⑧ | 30日終わって理解が残らん | ✅ **完了**（90問／30日） |
| ⑨ | Step ごとに撮ってへん | 🔄 重複検査を新設中＋撮り直し |
