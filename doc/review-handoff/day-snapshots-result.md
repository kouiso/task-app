...
- 出どころ: `python3 scripts/curriculum-qa/build_day_snapshots.py --all --verify`（2026-09-18 04:22 UTC / 30 日ぶん）
- 対象範囲: 全件実行
- 検証: 要求した（各段階の実行結果は表を参照）
- Prisma生成・tsc・build がすべて OK: 30 / 30 日
- ツリーの置き場: `dist/day-snapshots/dayNN/`
- 上書きしない実行記録: `dist/day-snapshots/result/20260918T042258.576861Z-94320974ea0c.json`
