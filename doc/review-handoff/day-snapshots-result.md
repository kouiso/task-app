...
- 出どころ: `python3 scripts/curriculum-qa/build_day_snapshots.py --all --verify`（2026-09-18 16:50 UTC / 30 日ぶん）
- 対象範囲: 全件実行
- 検証: 要求した（各段階の実行結果は表を参照）
- Prisma生成・tsc・build がすべて OK: 29 / 30 日
- ツリーの置き場: `dist/day-snapshots/dayNN/`
- 上書きしない実行記録: `dist/day-snapshots/result/20260918T165024.511377Z-929112da84b3.json`
...
| day22 | OK（107 ファイル） | OK | OK | OK | 再構築・検証中にソース入力が変更されました: before=d48e1345f06e43c28f4327531409046ceb655aaf30f67b518879b3a3545be321 after=a073a03cdd6959ab6ced00624ba6d54ee8c3b59617f7ed089e54120f9e614de7 |
