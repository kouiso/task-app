...
- 出どころ: `python3 scripts/curriculum-qa/build_day_snapshots.py --all --verify`（2026-09-19 16:44 UTC / 30 日ぶん）
- 対象範囲: 全件実行
- 検証: 要求した（各段階の実行結果は表を参照）
- Prisma生成・tsc・build がすべて OK: 30 / 30 日
- ツリーの置き場: `dist/day-snapshots/dayNN/`
- 上書きしない実行記録: `dist/day-snapshots/result/20260919T164450.292533Z-69baa3599ec5.json`
