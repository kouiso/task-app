...
- 出どころ: `python3 scripts/curriculum-qa/build_day_snapshots.py --day 1 --verify`（2026-09-18 10:12 UTC / 1 日ぶん）
- 対象範囲: 部分実行（day01）
- 検証: 要求した（各段階の実行結果は表を参照）
- Prisma生成・tsc・build がすべて OK: 1 / 1 日
- ツリーの置き場: `dist/day-snapshots/dayNN/`
- 上書きしない実行記録: `dist/day-snapshots/result/20260918T101232.189220Z-28bcf1b68613.json`
