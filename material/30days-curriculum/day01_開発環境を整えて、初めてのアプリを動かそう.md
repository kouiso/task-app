...
ブラウザに「もうこれプロダクトだ」と思える最初の画面を出せたら、
この30日が一気に現実味を帯びる。

今日触るのは、ただの Hello World ではありません。
Linear っぽい空気感をまとった、
「この先ちゃんと育ちそう」な一枚目を自分で立ち上げます。
...
しかも最後は、真っ白な初期画面のままでは終わらせません。
Linear 風の design token を使って、
SNS に貼っても「教材の練習感」が薄い一枚目に変えます。
