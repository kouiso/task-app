...
ようこそ！ 30日間カリキュラムの第1日目です。今日はこれから30日間で作り上げていくタスク管理アプリを、あなたのパソコンで実際に動かすところまで進めます。最初のセットアップは少し手順が多く感じるかもしれませんが、ひとつずつ進めれば大丈夫です。今日の終わりには、ブラウザに自分だけのアプリが表示される達成感を味わえます。
...
|------|---------|---------|-------------|---------|
| 1 | miseをインストールする | 10分 | なし | `mise --version` でバージョンが表示される |
...
| 12 | ブラウザでアプリを確認する | 10分 | なし | ログイン画面が表示される |
