...
![ユーザー詳細ページ。アバターと名前とロールのバッジの下に、参加プロジェクトと担当中のタスクのカードが並んでいる](./screenshots/day29/user-detail.png)
...
![読み込み中のユーザー詳細ページ。画面の中央に丸いスピナーだけが出ている](./screenshots/day29/user-detail-loading.png)
