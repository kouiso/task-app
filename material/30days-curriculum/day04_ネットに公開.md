...
Vercel に接続して公開し、本物の URL で開ける状態まで持っていけるようになります。
単に「デプロイボタンを押した」で終わらせず、次のことができるようになります。
...
Vercel に持っていく前に、
まずは Day 03 の終点がちゃんと揃っているか確認しましょう。
