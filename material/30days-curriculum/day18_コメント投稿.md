...
![コメント一覧がタスク詳細に表示されている画面](./screenshots/task-detail-dialog.png)
...
![テキストエリアと投稿ボタンが表示されている画面](./screenshots/task-detail-dialog.png)
...
![コメント投稿後にリストが更新された画面](./screenshots/task-detail-dialog.png)
