...
スクリーンショット: 下の画像は Step 3 まで書き終えた画面です。赤枠の中が、この Step で足したコメント一覧です。いまの自分の画面には、その下の投稿フォームがまだ出ていません。フォームは Step 4 で足します。
...
スクリーンショット: 下の画像は Step 4 まで書き終えた画面です。赤枠の中が、この Step で足したテキストエリアと投稿ボタンです。いまの自分の画面では、このボタンを押してもまだ何も起きません。押したときの処理は Step 5 で書きます。
