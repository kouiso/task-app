...
![パスワード欄の下に「パスワードを入力してください」という赤い文字が出ているログイン画面](./screenshots/day05/login-error.png)
...
![Card で囲まれたログインフォームが画面の中央に置かれている状態](./screenshots/day05/login.png)
...
![フォームの下に「アカウントをお持ちでない方は こちら」の登録リンクが付いたログイン画面](./screenshots/day05/login.png)
