...
Step 2で追加した `useQuery` を、フィルター付きに書き換えます。

💻 **実装**:

```typescript
// filepath: src/app/task/page.tsx
// Step 2のuseQueryをフィルター付きに書き換え
...
// ハンドラーの準備
// handleTaskClick は Step 7 で本実装に差し替え
...
![タスク詳細ダイアログ](./screenshots/task-detail-dialog.png)
