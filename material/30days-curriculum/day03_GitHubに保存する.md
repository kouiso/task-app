...
| Initialize this repository | チェックしない | チェックすると空のコミットが作られ、ローカルの履歴と衝突するため |
...
> ⚠️ **重要**: トークンは**一度しか表示されません**。ページを閉じると二度と見られないので、必ずコピーしてください。メモ帳に保存する場合は、他の人が見られない場所に置き、使い終わったら削除してください。
