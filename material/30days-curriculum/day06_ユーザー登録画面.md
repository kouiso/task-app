...
スクリーンショット: 下の画像は Step 9 まで書き終えた完成後の画面です。赤枠の中が、この Step で足した2つの欄です。いまの自分の画面には、その下のパスワードとパスワード(確認)の欄がまだ出ていません。2つとも Step 6 で足します。
...
スクリーンショット: 下の画像は Step 9 まで書き終えた完成後の画面です。赤枠の中が、この Step で足した2つの欄です。これで入力欄は4つそろいます。
