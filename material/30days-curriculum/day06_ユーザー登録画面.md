...
Day 05 で学んだ react-hook-form + zod パターンを応用して、ユーザー登録画面を作ります。パスワード確認チェックなど、より高度なバリデーションに挑戦します。

【スクリーンショット: 完成したユーザー登録画面】

## 🤔 なぜこれを作るのか？

ログインするには、まずアカウントが必要です。登録画面では、パスワードの確認入力や複数フィールドをまたぐバリデーションなど、実務でよく使うテクニックを学びます。
