...
![レポートページにステータス別・優先度別の円グラフが並んだ完成](./screenshots/report.png)
## 🤔 なぜこれを作るのか？
...
![ステータス別の円グラフが色分けされて表示されることを確認して](./screenshots/report.png)
---
...
![ステータスと優先度の2つの円グラフが表示されることを確認して](./screenshots/report.png)
---
