...
![ダッシュボード画面にウェルカムバナーが表示されている完成イメ](./screenshots/dashboard.png)
## 🤔 なぜこれを作るのか？
...
![ダッシュボードのタイトル下に「こんにちは！開発者さん」という](./screenshots/dashboard.png)
...
![ウェルカムメッセージがCardコンポーネントで囲まれ、薄い背](./screenshots/dashboard.png)
...
![VS Codeで赤い波線とエラーメッセージが表示されている画](./screenshots/dashboard.png)
...
![バナーに「タスク完了率: XX% — メッセージ」が表示され](./screenshots/dashboard.png)
