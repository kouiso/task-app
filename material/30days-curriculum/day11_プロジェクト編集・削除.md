...
![プロジェクト一覧。赤枠の中は Day 10 で自分で作ったカード。左には初期データの「Webサイトリニューアル」が並ぶ](./screenshots/day11/project-list-after-edit.png)
...
![確認ダイアログ。見出しが「本当に削除しますか？」、その下に「この操作は取り消せません。」と、キャンセル・削除の2つのボタンが並んでいる](./screenshots/day11/project-delete-confirm.png)
