...
アーカイブするのは「モバイルアプリ開発」にしてください。
初期データのもう1つ「Webサイトリニューアル」は、Day 13 以降でタスクを作る舞台になります。
...
1. プロジェクト一覧から「モバイルアプリ開発」のカードを開き、詳細画面のアーカイブボタンをクリック
2. 一覧から「モバイルアプリ開発」が非表示になることを確認
