...
const AccountBoxIcon: React.FC<IconProps> = ({ fillColor = '#495D68' }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_6003_311)">
      <path
        opacity="0.3"
        d="M5 19H19V5H5V19ZM12 6C13.65 6 15 7.35 15 9C15 10.65 13.65 12 12 12C10.35 12 9 10.65 9 9C9 7.35 10.35 6 12 6ZM6 16.47C6 13.97 9.97 12.89 12 12.89C14.03 12.89 18 13.97 18 16.47V18H6V16.47Z"
        fill={fillColor}
      />
      <path
