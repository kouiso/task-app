...
const RingPrimaryIcon: React.FC = () => (
  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_6029_263)">
      <path
        opacity="0.3"
        d="M18.5 6C19.0523 6 19.5 5.55228 19.5 5C19.5 4.44772 19.0523 4 18.5 4C17.9477 4 17.5 4.44772 17.5 5C17.5 5.55228 17.9477 6 18.5 6Z"
        fill="#38A576"
      />
      <path
        opacity="0.3"
