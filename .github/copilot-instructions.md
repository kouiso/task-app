...
地の文（コードブロック・引用以外）はすべて **ですます体**。
AI のペルソナが関西弁でも、教材本文には持ち込まない。ここが最も混入しやすい。
...
上記3つの機械検出: `python3 scripts/curriculum-qa/check_tone.py <file>`（`check_quality.sh` の Step 7 で自動実行）
