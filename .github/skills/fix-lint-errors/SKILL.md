...
TaskAppプロジェクトでは、**Biome 2.3.15** を使用しています。

**重要**: 原則はBiomeを使用します。Biomeで対応できない要件がある場合のみESLintを使用してください。
...
**エラー例**:
```
error[lint/suspicious/noConsole]: Don't use console.log in production code
```
