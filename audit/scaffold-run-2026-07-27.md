...
`scripts/scaffold-from-scratch.sh` で作るプロジェクトです。この2つは中身が違います。
...
確かめたのは Day 01 の初期セットアップと、教材が示す出力の一致までです。
Day 02 以降を1日ずつ写経して完走できるかは、この記録の対象外です。
